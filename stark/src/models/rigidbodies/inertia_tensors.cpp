...
Eigen::Matrix3d stark::models::inertia_tensor_sphere(double mass, double radius)
{
    double I = (2.0 / 5.0) * mass * radius * radius;
    Eigen::Matrix3d inertia_tensor = Eigen::Matrix3d::Identity() * I;
    return inertia_tensor;
}
Eigen::Matrix3d stark::models::inertia_tensor_cylinder(double mass, double radius, double height)
{
...
Eigen::Matrix3d stark::models::inertia_tensor_box(double mass, double size)
{
...
Eigen::Matrix3d stark::models::inertia_tensor_box(double mass, const Eigen::Vector3d& size)
{
...
Eigen::Matrix3d stark::models::inertia_tensor_torus(double mass, double b, double a)
{
    double a2 = a*a;
    double b2 = b*b;
