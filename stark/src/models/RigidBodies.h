...
namespace stark::models
{
	...
	*/
	...
	public:
		...
		PrismaticSliderHandler add_constraint_prismatic_slider(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& d_glob, double stiffness_per_kg = DEFAULT_HARD_STIFFNESS_PER_KG);
		...
		PrismaticPressHandler add_prismatic_press(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& d_glob, double target_v, double max_force, double delay = 0.01, double slider_stiffness_per_kg = DEFAULT_HARD_STIFFNESS_PER_KG);
		HingeWithMotorHandler add_motor_with_hinge(const RigidBodyHandler& body_a, const RigidBodyHandler& body_b, const Eigen::Vector3d& p_glob, const Eigen::Vector3d& d_glob, double target_w, double max_torque, double delay = 0.01, double hinge_stiffness_per_kg = DEFAULT_HARD_STIFFNESS_PER_KG);
