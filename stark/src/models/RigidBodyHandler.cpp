...
void stark::models::RigidBodyHandler::set_mass(double mass)
{
...
void stark::models::RigidBodyHandler::set_local_inertia_tensor(const Eigen::Vector3d& inertia_tensor)
{
...
void stark::models::RigidBodyHandler::add_to_output_label(const std::string label)
{
	this->rb->output_groups.add_to_group(label, this->idx);
}

void stark::models::RigidBodyHandler::set_collision_mesh(const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 3>>& triangles)
{
	this->rb->collision_meshes[this->idx].vertices = vertices;
	this->rb->collision_meshes[this->idx].conn = triangles;
}

void stark::models::RigidBodyHandler::set_render_mesh(const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 3>>& triangles)
{
