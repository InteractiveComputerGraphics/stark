...
namespace stark::utils
{
	...
	Mesh make_cylinder(const double radius, const double height, const int slices = 16, const int stacks = 1);
	Mesh make_cone(const double radius, const double height, const int slices = 16, const int stacks = 1);
