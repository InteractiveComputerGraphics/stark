...
void stark::core::AdaptiveParameter::set(double min, double value, double max)
{
...
void stark::core::AdaptiveParameter::successful_iteration()
{
...
bool stark::core::AdaptiveParameter::failed_iteration()
{
	this->current_successful_iterations = 0;
