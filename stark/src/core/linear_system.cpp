...
int stark::core::solve_linear_system_with_CG(Eigen::VectorXd& solution_with_initial_guess, BCRS& lhs, const Eigen::VectorXd& rhs, const int max_iterations, const double tol, const int n_threads)
{
...
void stark::core::solve_linear_system_with_directLU(Eigen::VectorXd& solution, BCRS& lhs, const Eigen::VectorXd& rhs)
{
